# Extending and Embedding the Python Interpreter — Python 3.14.0 documentation
...
introduction to the language, see The Python Tutorial . The Python Language Reference gives a more formal definition of the language. The Python Standard Library documents
...
- 3. Defining Extension Types: Assorted Topics 3.1. Finalization and De-allocation 3.2. Object Presentation 3.3. Attribute Management 3.4. Object Comparison 3.5. Abstract Protocol Support 3.6. Weak Reference Support 3.7. More Suggestions
...
---
Quelle: https://docs.python.org/3/extending/index.html