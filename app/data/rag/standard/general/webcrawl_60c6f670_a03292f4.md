...
Download and extract keycloak-26.4.6.zip from the Keycloak website.
After extracting this file, you should have a directory that is named keycloak-26.4.6 .

## Start Keycloak

- From a terminal, open the keycloak-26.4.6 directory.
From a terminal, open the keycloak-26.4.6 directory.
- Enter the following command: On Linux, run: bin/kc.sh start-dev On Windows, run: bin\kc.bat start-dev
...
---
Quelle: https://www.keycloak.org/getting-started/getting-started-zip