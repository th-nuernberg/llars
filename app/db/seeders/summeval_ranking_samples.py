...
RANKING_SAMPLES = [
    {
        "subject": "Summary Ranking: News Article 1",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """-lrb- cnn -rrb- donald sterling 's racist remarks cost him an nba team last year . but now it 's his former female companion who has lost big . a los angeles judge has ordered v. stiviano to pay back more than $ 2.6 million in gifts after sterling 's wife sued her .""",
                "human_scores": {
                    "relevance": 3.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "B",
                "content": """a los angeles judge has ordered v. stiviano to pay back more than $ 2.6 million in gifts after sterling 's wife sued her . in the lawsuit , rochelle `` shelly '' sterling accused stiviano of targeting extremely wealthy older men . she claimed donald sterling used the couple 's money to buy stiviano a ferrari , two bentleys and a range rover , and that he helped her get a $ 1.8 million duplex .""",
                "human_scores": {
            ...
            {
                "id": "D",
                "content": """donald sterling 's racist remarks cost him an nba team last year . in the lawsuit , rochelle `` shelly '' sterling used the couple 's money to buy stiviano a ferrari , wealthy older men . shelly sterling 's gifts from donald sterling was $ 2.6 million in gifts .""",
                "human_scores": {
            ...
            {
                "id": "E",
                "content": """donald sterling , nba team last year . sterling 's wife sued for $ 2.6 million in gifts . sterling says he is the former female companion who has lost the . sterling has ordered v. stiviano to pay back $ 2.6 m in gifts after his wife sued . sterling also includes a $ 391 easter bunny costume , $ 299 and a $ 299 .""",
                "human_scores": {
                    "relevance": 1.6666666666666667,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 2",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """north pacific gray whale has earned a spot in the record books . the whale , named varvara , swam nearly 14,000 miles -lrb- 22,500 kilometers -rrb- . varvara , which is russian for `` barbara , '' left her primary feeding ground off russia .""",
                "human_scores": {
            ...
            {
                "id": "B",
                "content": """the whale , named varvara , swam nearly 14,000 miles ( 22,500 kilometers ) . it said the previous record was set by a humpback whale that swam a mere 10,190-mile round trip between the `` warm breeding waters of the arctic and antarctic regions '' .""",
                "human_scores": {
            ...
            {
                "id": "C",
                "content": """a north pacific gray whale swam nearly 14,000 miles from oregon state university . varvara 's journey surpassed a record listed on the guinness worlds records . the whale is russian for `` barbara , '' which is set by a humpback whale .""",
                "human_scores": {
                    "relevance": 2.0,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 3",
        ...
        "summaries": [
            ...
            {
                "id": "B",
                "content": """a u.s. rc-135u was flying over the baltic sea when it was intercepted by a russian flanker . the pentagon said the incident occurred in international airspace north of poland . the u.s. crew believed the russian pilot 's actions were `` unsafe and unprofessional , '' pentagon says .""",
                "human_scores": {
                    "relevance": 4.333333333333333,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """the incident occurred in international airspace north of poland . the u.s. crew believed the russian pilot 's actions were `` unsafe and unprofessional due to the aggressive maneuvers it performed in close proximity to their aircraft and its high rate of speed '' .""",
                "human_scores": {
                    "relevance": 1.6666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """( cnn ) after a russian fighter jet intercepted a u.s. reconnaissance plane in an " unsafe and unprofessional manner " earlier this week , the united states is complaining to moscow about the incident . on tuesday , a u.s. rc - 135u was flying over the baltic sea when it was intercepted by a russian su - 27 flanker . the pentagon said the incident occurred in international airspace north of poland .""",
                "human_scores": {
                    "relevance": 4.666666666666667,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 4",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """lady antebellum singer hillary scott's tour bus catches fire on a texas freeway . everyone on board was evacuated safely, scott posts on instagram .""",
                "human_scores": {
                    "relevance": 4.666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "B",
                "content": """hillary scott 's tour bus caught fire on a texas freeway thursday morning . smoke and flames poured from the rear of the bus as traffic slowed to a crawl and barnett slowly approached in his vehicle . barnett said he did n't realize at the time that the bus belonged to the country band .""",
                "human_scores": {
                    "relevance": 3.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """lady antebellum 's tour bus caught fire on a texas freeway thursday morning . michael barnett captured dramatic video of fire on interstate 30 . he decided to stop filming because he did n't know what to expect . hillary scott , co-lead singer , posted a photo of the charred bus on instagram .""",
                "human_scores": {
                    "relevance": 3.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """hillary scott 's tour bus caught fire on a texas freeway thursday morning . michael barnett captured dramatic video of the fire , on interstate 30 just northeast of dallas . barnett decided to stop filming because he did n't know what to expect .""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
    ...
    },
    {
        ...
        "summaries": [
            ...
            {
                "id": "B",
                "content": """A fiery sunset greeted people in Washington Sunday.""",
                "human_scores": {
                    "relevance": 1.6666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """stunning sunsets were the result of raging wildfires in parts of siberia . fires were started in southeastern siberia , by farmers burning grass in their fields . but on april 14 , it is believed that the flames quickly grew out of control .""",
                "human_scores": {
            ...
            {
                "id": "E",
                "content": """the deep reddish color caught seattle native tim durkan 's eye . the stunning sunsets were the result of raging wildfires in parts of siberia . the fires were started in southeastern siberia , by farmers burning grass in their fields .""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 6",
        ...
        "summaries": [
            ...
            {
                "id": "C",
                "content": """a total of 8,480 migrants were rescued . the group fears 400 migrants could be missing . the italian coast guard has not yet found evidence . italy registered more than 10,000 migrants in the first three months of 2015 .""",
                "human_scores": {
                    "relevance": 2.6666666666666665,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 7",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """-lrb- cnn -rrb- spacex on tuesday launched a two-stage falcon 9 rocket carrying an uncrewed cargo spacecraft called dragon on a flight from cape canaveral , florida , to the international space station . that was the easy part . dragon enroute to space station .""",
                "human_scores": {
                    "relevance": 2.3333333333333335,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """-lrb- cnn -rrb- spacex on tuesday launched a two-stage falcon 9 rocket carrying an uncrewed cargo spacecraft called dragon on a flight from cape canaveral , florida , to the international space station . that was the easy part . in a difficult bid to land a rocket stage on a floating barge for the first time , the private space exploration company was unsuccessful .""",
                "human_scores": {
                    "relevance": 4.666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """spacex founder elon musk tweeted : `` ascent successful . rocket landed on droneship , but too hard for survival '' . spacex has said it will keep trying and , after it hit at an angle and exploded .""",
                "human_scores": {
                    "relevance": 2.0,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 8",
        "source_text": """(CNN)Two passengers found dead on a cruise ship in Puerto Rico appear to have died in a murder-suicide, the cruise line said. Holland America Line said two guests were found dead inside their stateroom on the ms Ryndam at 11:30 a.m. Thursday. "The cabin was immediately secured, and the authorities were notified, including the FBI," Holland America said. "We are cooperating fully with the investigation, and the authorities will make the official determination on what occurred." FBI spokesman Moises Quiñones said authorities were on scene investigating. The ship left Tampa, Florida, on March 29 on a 14-day Southern Caribbean cruise. It's currently in San Juan, Puerto Rico. Puerto Rico Port Authority spokesman Efraín Santiago told El Nuevo Dia newspaper that the cleaning staff on the ship had discovered the deceased passengers after knocking on the cabin's door.""",
        "summaries": [
            {
                "id": "A",
                "content": """holland left tampa , florida , on march 29 . two passengers found dead inside their stateroom on the ship . it 's in san juan , puerto rico .""",
                "human_scores": {
                    "relevance": 3.3333333333333335,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "B",
                "content": """Holland America Line says two guests were found dead inside their stateroom . The ship left Tampa , Florida , on March 29 on a 14-day Southern Caribbean cruise . Puerto Rico Port Authority spokesman Efraín Santiago says cleaning staff discovered the deceased passengers .""",
                "human_scores": {
                    "relevance": 4.333333333333333,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """-lrb- cnn -rrb- two passengers found dead on a cruise ship in puerto rico appear to have died in a murder-suicide , the cruise line said . holland america line said two guests were found dead inside their stateroom on the ms ryndam at 11:30 a.m. thursday . `` the cabin was immediately secured , and the authorities were notified , including the fbi , '' holland america said .""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """( cnn ) two passengers found dead on a cruise ship in puerto rico appear to have died in a murder - suicide , the cruise line said . holland america line said two guests were found dead inside their stateroom on the ms ryndam at 11:30 a.m. thursday . the ship left tampa , florida , on march 29 on a 14 - day southern caribbean cruise .""",
                "human_scores": {
                    "relevance": 4.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """two passengers found dead on a cruise ship in puerto rico appear to have died in a murder-suicide . the ship left tampa , florida , on a 14-day southern caribbean cruise .""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
    ...
    },
    {
        ...
        "summaries": [
            ...
            {
                "id": "C",
                "content": """yazidis are of kurdish descent , and their religion is considered a pre-islamic sect that draws from christianity , judaism and zoroastrianism . isis ' conquest of the town of sinjar , in particular , provoked a major humanitarian crisis .""",
                "human_scores": {
                    "relevance": 1.6666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """most of those released were women and children ; the rest were ill or elderly , officials say . freed yazidis , a minority group , captured and displaced in northern iraq last summer . arab tribal leaders did not say what led to release .""",
                "human_scores": {
                    "relevance": 3.3333333333333335,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """-lrb- cnn -rrb- isis on wednesday released more than 200 yazidis , a minority group whose members were killed , captured and displaced when the islamist terror organization overtook their towns in northern iraq last summer , officials said . most of those released were women and children ; the rest were ill or elderly , said rassol omar , a commander in the peshmerga force that defends northern iraq 's semi-autonomous kurdish region . omar did n't say what led to the release , other than asserting that arab tribal leaders helped to coordinate it .""",
                "human_scores": {
                    "relevance": 4.333333333333333,
                    "coherence": None,
                    "consistency": None,
    ...
    },
    {
        ...
        "summaries": [
            ...
            {
                "id": "B",
                "content": """eight iranian border guards killed in clashes with militants near the border with pakistan, iranian state media reports . a militant group called jaish al adal claimed responsibility for the attack .""",
                "human_scores": {
                    "relevance": 4.666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """( cnn ) eight iranian border guards have been killed in clashes with militants near the border with pakistan , iranian state media reported . three of the militants were killed by iranian forces in the fighting monday in the southeastern town of negur , the state - run news agency irna reported . a militant group called jaish al adal claimed responsibility for the attack , according to iranian state media and a twitter account believed to be associated with the organization .""",
                "human_scores": {
                    "relevance": 4.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """The Iranian border guards were killed by militants in the eastern province of Baluchistan. Iran is a major ally of Pakistan in the region.""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """three of the militants were killed by iranian forces in the fighting monday in the southeastern town of negur . iranian officials have reportedly asked pakistani authorities to catch the surviving assailants . jaish al adal has also claimed responsibility for the attack .""",
                "human_scores": {
                    "relevance": 3.0,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 11",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """`` space invaders '' was developed in japan back in the late 1970 's -- and now their real-life counterparts are the topic of an earnest political discussion in japan 's corridors of power . luckily , japanese can sleep soundly in their beds tonight as the government 's top military official earnestly . inoki has appeared in the u.s.-based wwe -- which describes him as `` among the most respected men in sports-entertainment '' .""",
                "human_scores": {
            ...
            {
                "id": "B",
                "content": """Japan's military has never seen an alien, and apparently never will. Image: AP This article originally published at The Daily Dot here""",
                "human_scores": {
                    "relevance": 2.6666666666666665,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """japan's top military official reveals that the country's air self defense force has never encountered an extraterrestrial unidentified flying object . defense minister gen nakatani told the diet that his jets had, to date, never come across any ufos from outer space . inoki has claimed to have seen a ufo with his own eyes, but admitted that he didn't know personally if aliens existed .""",
                "human_scores": {
                    "relevance": 4.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """`` space invaders '' was developed in japan back in 1970 . japanese can sleep soundly in their beds tonight as government 's top military official . he also fought muhammad ali in 1976 . inoki has appeared in the u.s.-based wwe .""",
                "human_scores": {
                    "relevance": 1.0,
                    "coherence": None,
                    "consistency": None,
    ...
    },
    {
        ...
        "summaries": [
            ...
            {
                "id": "B",
                "content": """-lrb- cnn -rrb- the parents of the youngest victim of the boston marathon bombings are making an emotional , passionate plea to take the death penalty off the table for the man convicted in the case . last week , dzhokhar tsarnaev was found guilty on all 30 charges he faced related to the bombings at the 2013 race and the dramatic violence that dragged out for days afterward . a look at all of the charges .""",
                "human_scores": {
                    "relevance": 4.666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """dzhokhar tsarnaev was found guilty on all 30 charges in the 2013 race . it is expected to last four weeks , a day after the race . the 13th juror : now it is real .""",
                "human_scores": {
                    "relevance": 1.6666666666666667,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """the sentencing phase begins tuesday , a day after this year 's edition of the landmark race . it is expected to last four weeks . bill and denise richard wrote about the toll taken on their family after the death of their 8-year-old son , martin .""",
                "human_scores": {
                    "relevance": 2.0,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 13",
        "source_text": """(CNN)One of the biggest TV events of all time is being reimagined for new audiences. "Roots," the epic miniseries about an African-American slave and his descendants, had a staggering audience of over 100 million viewers back in 1977. Now A&E networks are remaking the miniseries, to air in 2016. A&E, Lifetime and History (formerly the History Channel) announced Thursday that the three networks would simulcast a remake of the saga of Kunta Kinte, an African who was captured, shipped to America and sold into slavery to work on a Virginia plantation. LeVar Burton, who portrayed Kinte in the original, will co-executive produce the new miniseries. A press release describes the new version as "original" and "contemporary" and will draw more from Alex Haley's classic novel, "Roots: The Saga of an American Family." Producers will consult scholars in African and African-American history for added authenticity. "We are proud to bring this saga to fans of the original, as well as to a new generation that will experience this powerful and poignant tale for the first time," said Dirk Hoogstra, History's executive vice president and general manager. "Audiences will once again feel the impact of Kunta Kinte's indomitable spirit." Executive producer Mark Wolper, son of the original's producer David L. Wolper, added, "Kunta Kinte began telling his story over 200 years ago and that story went through his family lineage, to Alex Haley, to my father, and now the mantle rests with me. Like Kunta Kinte fought to tell his story over and over again, so must we." The remade "Roots" will encounter a new generation of viewers who have witnessed Barack Obama make history as the nation's first African-American president and "12 Years a Slave" win the Oscar for Best Picture, but also widespread racial unrest over police treatment of black suspects in many U.S. cities. "My career began with 'Roots' and I am proud to be a part of this new adaptation," said Burton. "There is a huge audience of cont...""",
        "summaries": [
            {
                "id": "A",
                "content": """`` roots , '' the epic miniseries about an african-american slave and his descendants , had a staggering audience of over 100 million viewers back in 1977 . a&e networks are remaking the miniseries , to air in 2016 . levar burton , who portrayed kinte in the original , will co-executive produce the new miniseries .""",
                "human_scores": {
                    "relevance": 5.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "B",
                "content": """A&E Networks will simulcast the original "Roots" in 2016. The original "Roots" premiered in 1977 and ran for four seasons. The miniseries followed Kunta Kinte, a free black man in Virginia, as he was sold into slavery.""",
                "human_scores": {
                    "relevance": 4.333333333333333,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """a&e , lifetime and history are remaking the miniseries , to air in 2016 . `` roots , '' levar burton , will co-executive produce the new miniseries . alex haley 's `` contemporary '' novel is `` original '' novel .""",
                "human_scores": {
                    "relevance": 2.3333333333333335,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """`` roots , '' the epic miniseries about an african-american slave and his descendants , had a staggering audience of over 100 million viewers back in 1977 . now a&e networks are remaking the miniseries , to air in 2016 .""",
                "human_scores": {
                    "relevance": 4.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "E",
                "content": """a&e networks are remaking the series , to air in 2016 . the three networks will broadcast a remake of the saga of kunta kinte . the `` roots '' is the epic episode of the african-american slave and his descendants . the series of `` original '' and `` contemporary '' will be the new version of the original version .""",
                "human_scores": {
                    "relevance": 3.3333333333333335,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 14",
        ...
        "summaries": [
            ...
            {
                "id": "B",
                "content": """ten people , including four children , have been involved in a multi-vehicle crash in brisbane 's west . three vehicles collided on the brisbane valley highway , 2km south of fernvale , on wednesday afternoon . a 40-year-old man with chest and shoulder injuries and a five-year-old boy with chest pain were the first patients flown out by rescue helicopter .""",
                "human_scores": {
                    "relevance": 5.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """three vehicles collided on the brisbane valley highway , 2km south of fernvale . a 40-year-old man with chest and shoulder injuries and a five-year-old girl suffering from abdominal pain were also being flown out . a man has also suffered hand lacerations and two females escaped injuries .""",
                "human_scores": {
                    "relevance": 4.0,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "D",
                "content": """One person was trapped inside their car. The helicopter landed at the scene and airlifted a number of patients to hospital. © Nine Digital Pty Ltd 2018""",
                "human_scores": {
                    "relevance": 2.6666666666666665,
                    "coherence": None,
                    "consistency": None,
    ...
    {
        "subject": "Summary Ranking: News Article 15",
        ...
        "summaries": [
            {
                "id": "A",
                "content": """Serena Williams won 6-3 6-3 against Sara Errani to become the first woman to win four majors Williams was happy with her performance in the Fed Cup, but she was not impressed by the way Errani had played Errani and Pennetta were beaten 6-0 6-3 by Williams and Alison Riske in the doubles rubber Errani was not impressed by Williams' display, saying: 'I didn't play bad today but""",
                "human_scores": {
                    "relevance": 2.6666666666666665,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "B",
                "content": """french open champion serena williams says her struggle to beat sara errani . serena williams beat italian sara errani in the fed cup play-off . williams eventually prevailed 4-6 7-6 -lrb- 3 -rrb- 6-3 against italian . williams and alison riske were relegated to world group ii . williams won her 19th singles grand slam at the australian open .""",
                "human_scores": {
                    "relevance": 3.6666666666666665,
                    "coherence": None,
                    "consistency": None,
            ...
            {
                "id": "C",
                "content": """serena williams beat sara errani 4-6 7-6 -lrb- 3 -rrb- in the fed cup . the claycourt season gets into full swing . world no 1 williams defeated sara errani in the semi-finals . the american tennis star is to beat the italian sara errani .""",
                "human_scores": {
                    "relevance": 3.0,
                    "coherence": None,
                    "consistency": None,
