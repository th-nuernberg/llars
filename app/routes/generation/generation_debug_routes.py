...
def add_llm_evaluators():
    ...
    {
        "scenario_id": 7,
        "llm_evaluators": ["Global/Mistral/Mistral-Small-3.2-24B-Instruct-2506"],
        "run_evaluation": true
    }
    """
    data = request.get_json() or {}
...
def start_test_job():
    ...
    Request body:
    {
        ...
        "llm_models": ["Global/Mistral/Mistral-Small-3.2-24B-Instruct-2506"],
        "items": [
...
Schreibe eine hilfreiche, lösungsorientierte Antwort."""
        ...
        config = {
            ...
            "prompts": [{"template_id": prompt_id, "variant_name": "Standard"}],
            "llm_models": data.get("llm_models", ["Global/Mistral/Mistral-Small-3.2-24B-Instruct-2506"]),
            "sources": {
                "type": "manual",
