...
def delete_case(case_id: int):
    ...
    try:
        ...
        raise ValidationError(f"Case has {e.assessment_count} assessments. Use force=true to delete anyway.")
...
def add_document(case_id: int):
    ...
    if not title or not content or not document_type:
        raise ValidationError("title, content, and document_type are required")
