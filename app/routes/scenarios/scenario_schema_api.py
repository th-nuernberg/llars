...
def get_evaluation_types():
    ...
    types = [
        ...
        {
            'id': 'communication_comparison',
            'function_type_id': 8,
            'name': {'de': 'Kommunikations-Vergleich', 'en': 'Communication Comparison'},
            'description': {
                'de': 'A/B-Auswahl im Beratungskontext: welche Antwort würdest du senden?',
                'en': 'Counselling-style A/B pick: which reply would you send?'
            }
        },
        {
            'id': 'conversation_labeling',
            'function_type_id': 9,
            'name': {'de': 'Konversationslabeling', 'en': 'Conversation Labeling'},
            'description': {
                'de': 'Spans in einem Gesprächsverlauf der Reihe nach labeln',
                'en': 'Label spans inside a conversation, in reading order'
            }
        }
    ]
