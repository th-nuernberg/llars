    ...
    return jsonify({
        ...
        'data': {
            ...
            'eval_types': [
                ...
                {'id': 'communication_comparison', 'name': 'Communication Comparison',
                 'description': 'Counselling-style A/B: which reply would you send?'},
                {'id': 'conversation_labeling', 'name': 'Conversation Labeling',
                 'description': 'Label spans inside a conversation, in reading order'},
            ],
            'presets': {
                ...
                'conversation_labeling': ['binary-authentic', 'sentiment-3', 'multi-label'],
