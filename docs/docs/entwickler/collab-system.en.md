...
This page documents the real-time collaboration system for the Markdown editor.
...
socket.emit('join_room', {
  room: 'markdown_15',    // Document room
  username: 'admin'
})
...
const collaboration = useYjsCollaboration(
  roomId,           // Ref<string> - e.g. 'markdown_15'
  username,         // string
...
const emit = defineEmits([
  'content-change',
  'document-saved'  // For Git panel updates
])
