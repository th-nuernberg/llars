<template>
  <v-dialog
    ...
    persistent
    scrollable
    class="chatbot-wizard-dialog"
  >
    <v-card class="wizard-card d-flex flex-column">
      <!-- Header -->
...
<style scoped>
/* Fix dialog size (avoid growing while steps progress) */
.chatbot-wizard-dialog :deep(.v-overlay__content) {
