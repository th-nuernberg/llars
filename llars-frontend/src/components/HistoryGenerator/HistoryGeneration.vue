      ...
      <div class="threads-grid">
        ...
        <template v-else>
          <div
            ...
            class="thread-card"
            :class="{ 'is-done': thread.progression_status === 'Done' }"
...
const doneCount = computed(() => emailThreads.value.filter(t => t.progression_status === 'Done').length)
...
function getStatus(thread) {
  if (thread.progression_status === 'Done') return 'done'
  if (thread.progression_status === 'Progressing') return 'in_progress'
  return 'pending'
}
