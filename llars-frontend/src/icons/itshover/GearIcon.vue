<template>
  <svg
    class="l-its-hover__svg l-its-hover--gear"
    ...
    aria-hidden="true"
  >
    <g class="l-its-hover__gear-rotator">
      <circle class="l-its-hover__gear-center" cx="16" cy="16" r="5" />
      <path
        class="l-its-hover__gear-body"
