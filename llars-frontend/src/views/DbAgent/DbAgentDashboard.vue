<template>
  <div class="db-agent-page" :class="{ 'is-mobile': isMobile }">
    ...
    <!-- Search Bar (desktop only, above tabs) -->
    <div v-if="!isMobile" class="search-bar mt-3">
      <!-- Station row -->
...
/* =====================================================
   ...
   Uses same pattern as MarkdownCollabWorkspace for consistent mobile detection
   ===================================================== */
