<template>
  <section id="features" class="features-section" :class="{ 'dark-mode': isDarkMode }">
...
const features = [
  ...
  { key: 'chatbot',      icon: 'mdi-robot-happy-outline', color: '#a8c5e2', span: 4  },
  { key: 'auth',         icon: 'mdi-shield-lock',       color: '#e8a087', span: 4  },
  { key: 'copilot',      icon: 'mdi-lightbulb-on-outline', color: '#c9a8e2', span: 8  },
  { key: 'designSystem', icon: 'mdi-palette-swatch',    color: '#b0ca97', span: 4  },
]
