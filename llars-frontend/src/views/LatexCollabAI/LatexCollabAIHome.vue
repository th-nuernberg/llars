    ...
    <div class="page-header" :class="{ 'flex-column align-start': isMobile }">
      <div>
        ...
        <div v-if="!isMobile" class="text-body-2 text-medium-emphasis mt-1">
          LaTeX-Editor mit KI-Schreibassistent (Ghost Text, @-Commands, RAG Citations)
        </div>
      </div>
      ...
      <div class="d-flex align-center">
        ...
        <div>
          ...
          <div class="text-body-2 mt-1">
            Diese Version enthält experimentelle KI-Features:
            Ghost Text Completion, @-Commands, AI Sidebar und RAG-basierte Literatursuche.
          </div>
        </div>
      </div>
    </v-alert>
