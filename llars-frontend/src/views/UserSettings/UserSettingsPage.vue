...
const VALID_TABS = ['personal', 'preferences', 'apikeys', 'providers', 'referrals', 'admin']
...
const availableTabs = computed(() => {
  const tabs = [
    ...
    { value: 'preferences', label: t('userSettings.tabs.preferences'), icon: 'mdi-tune-variant' },
...
function getTabDescription(tab) {
  const descriptions = {
    ...
    preferences: t('userSettings.preferences.description', 'Persönliche Präferenzen und Tastatur-Shortcuts'),
