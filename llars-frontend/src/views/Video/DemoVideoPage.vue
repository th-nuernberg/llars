    ...
    <div class="video-page__container">
      ...
      <div class="video-page__info">
        ...
        <div class="video-page__footer">
          ...
          <!-- Backup only: the self-hosted <video> above is the primary source;
               this YouTube mirror is a fallback if the file won't play. -->
          <span class="video-page__meta-item">
            <v-icon size="14" class="mr-1">mdi-youtube</v-icon>
            {{ $t('home.videoPage.backupLabel') }}
            <a
              href="https://www.youtube.com/watch?v=3QaKouwr4gU"
              target="_blank"
              rel="noopener noreferrer"
            >{{ $t('home.videoPage.backupLink') }}</a>
          </span>
