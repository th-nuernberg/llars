...
describe('evaluationSchemas - Enums & Constants', () => {
  ...
  it('SCHEMA_005: EvaluationType has exactly 8 types', () => {
    // 6 generic (rating/ranking/labeling/comparison/mail_rating/authenticity)
    // + 2 LLARS-specific specialisations: communication_comparison (8, A/B over
    // comparison) and conversation_labeling (9, span-level labeling in context)
    expect(Object.keys(EvaluationType)).toHaveLength(8)
  })
