...
describe('sanitizeHtml', () => {
  ...
  it('UTIL_SAN_015: strips style attribute (CSS-injection hardening)', () => {
    // Security (Pentest 2026-06-10): style is no longer allowed — LLM/imported
    // content could otherwise overlay/spoof the UI via inline CSS.
