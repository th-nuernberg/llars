...
# Security (Pentest 2026-06-10): .env enthält DB-Passwörter, Secret-/Encryption-
# Keys und API-Keys. Bei jedem Start auf 0600 erzwingen, damit ein versehentlich
# world-readable .env (Default beim Kopieren aus dem Template) nicht von anderen
# lokalen Usern / Containern mit Host-Mount gelesen werden kann.
chmod 600 "$ENV_FILE" 2>/dev/null || echo "WARN: konnte .env-Rechte nicht auf 600 setzen"
